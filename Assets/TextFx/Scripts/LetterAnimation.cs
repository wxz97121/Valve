...
namespace TextFx
{
	...
	public class LetterAnimation
	{
		...
		public Boomlagoon.JSON.tfxJSONValue ExportDataAsPresetSection(bool saveSampleTextData = true)
		{
			Boomlagoon.JSON.tfxJSONObject json_data = new Boomlagoon.JSON.tfxJSONObject();
			
			if(m_loop_cycles.Count > 0)
			{
				Boomlagoon.JSON.tfxJSONArray loops_data = new Boomlagoon.JSON.tfxJSONArray();
			...
			Boomlagoon.JSON.tfxJSONArray actions_data = new Boomlagoon.JSON.tfxJSONArray();
		...
		public void ImportPresetSectionData(Boomlagoon.JSON.tfxJSONObject json_data, LetterSetup[] letters, string assetNameSuffix = "")
		{
			m_letter_actions = new List<LetterAction>();
			m_loop_cycles = new List<ActionLoopCycle>();
		...
		public void ImportPresetSectionData(Boomlagoon.JSON.tfxJSONObject json_data, LetterSetup[] letters, int action_insert_index, int loop_insert_index, string assetNameSuffix = "")
		{
		...
		public void ImportPresetSectionData(Boomlagoon.JSON.tfxJSONObject json_data, LetterSetup[] letters, int action_insert_index, int loop_insert_index, ref int num_actions_added, ref int num_loops_added, string assetNameSuffix = "")
		{
			if(m_letter_actions == null)
				m_letter_actions = new List<LetterAction>();
			...
			LetterAction letter_action;
			num_actions_added = 0;
			foreach(Boomlagoon.JSON.tfxJSONValue action_data in json_data["ACTIONS_DATA"].Array)
			{
			...
			if(json_data.ContainsKey("LOOPS_DATA"))
			{
				...
				foreach(Boomlagoon.JSON.tfxJSONValue loop_data in json_data["LOOPS_DATA"].Array)
				{
		...
		public void ImportData(Boomlagoon.JSON.tfxJSONObject json_data, string assetNameSuffix = "")
		{
