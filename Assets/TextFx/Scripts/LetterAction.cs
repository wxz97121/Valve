...
namespace TextFx
{
	...
	public class EffectItemSetup
	{
		...
		public void ExportBaseData(ref Boomlagoon.JSON.tfxJSONObject json_data)
		{
		...
		public void ImportBaseData(Boomlagoon.JSON.tfxJSONObject json_data)
		{
	...
	public class LetterAction
	{
		...
		public Boomlagoon.JSON.tfxJSONValue ExportData()
		{
			...
			Boomlagoon.JSON.tfxJSONArray audio_effects_data = new Boomlagoon.JSON.tfxJSONArray();
			foreach(AudioEffectSetup effect_setup in m_audio_effects)
			{
			...
			Boomlagoon.JSON.tfxJSONArray particle_effects_data = new Boomlagoon.JSON.tfxJSONArray();
			foreach(ParticleEffectSetup effect_setup in m_particle_effects)
			{
		...
		public void ImportData(Boomlagoon.JSON.tfxJSONObject json_data, string assetNameSuffix = "", float timing_scale = -1)
		{	
			...
			foreach(Boomlagoon.JSON.tfxJSONValue audio_data in json_data["AUDIO_EFFECTS_DATA"].Array)
			{
			...
			foreach(Boomlagoon.JSON.tfxJSONValue particle_data in json_data["PARTICLE_EFFECTS_DATA"].Array)
			{
