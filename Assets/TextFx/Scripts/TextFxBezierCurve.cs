...
//			float length_val;
	...
	//	}
		...
		public Boomlagoon.JSON.tfxJSONValue ExportData()
		{
			...
			Boomlagoon.JSON.tfxJSONArray anchors_data = new Boomlagoon.JSON.tfxJSONArray();
			Boomlagoon.JSON.tfxJSONObject anchor_point_data;
			
			foreach(BezierCurvePoint anchor_point in m_anchor_points)
			{
				anchor_point_data = new Boomlagoon.JSON.tfxJSONObject();
		...
		public void ImportData(Boomlagoon.JSON.tfxJSONObject json_data)
		{
			...
			Boomlagoon.JSON.tfxJSONObject anchor_json;
			
			foreach(Boomlagoon.JSON.tfxJSONValue anchor_data in json_data["ANCHORS_DATA"].Array)
			{
