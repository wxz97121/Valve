...
namespace TextFx
{
	...
	public abstract class ActionVariableProgression
	{
		...
		protected void ExportBaseData(ref Boomlagoon.JSON.tfxJSONObject json_data)
		{
		...
		protected void ImportBaseData(Boomlagoon.JSON.tfxJSONObject json_data)
		{
		...
		public abstract Boomlagoon.JSON.tfxJSONValue ExportData();

		public abstract void ImportData(Boomlagoon.JSON.tfxJSONObject json_data);
	...
	public class ActionFloatProgression : ActionVariableProgression
	{
		...
		public override Boomlagoon.JSON.tfxJSONValue ExportData()
		{
		...
		public override void ImportData(Boomlagoon.JSON.tfxJSONObject json_data)
		{
...
//			}
		...
		public override Boomlagoon.JSON.tfxJSONValue ExportData()
		{
			Boomlagoon.JSON.tfxJSONObject json_data = base.ExportData().Obj;
