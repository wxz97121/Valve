...
//		,EndOfLoopSkipBreaks
	...
	public class AxisEasingOverrideData
	{
		...
		public Boomlagoon.JSON.tfxJSONValue ExportData()
		{
			...
			return new Boomlagoon.JSON.tfxJSONValue(json_data);
		}
		
		public void ImportData(Boomlagoon.JSON.tfxJSONObject json_data)
		{
	...
	public static class TextFxHelperMethods
	{
		...
		public static Boomlagoon.JSON.tfxJSONArray ExportData (this List<int> list)
		{
			Boomlagoon.JSON.tfxJSONArray json_array = new Boomlagoon.JSON.tfxJSONArray();
		...
		public static List<int> JSONtoListInt (this Boomlagoon.JSON.tfxJSONArray json_array)
		{
			List<int> int_list = new List<int>();
			
			foreach(Boomlagoon.JSON.tfxJSONValue int_val in json_array)
			{
		...
		public static Boomlagoon.JSON.tfxJSONValue Vector2ToJSON (this Vector2 vec)
		{
			Boomlagoon.JSON.tfxJSONObject json_data = new Boomlagoon.JSON.tfxJSONObject();
			json_data["x"] = vec.x;
			json_data["y"] = vec.y;
		...
		public static Vector2 JSONtoVector2 (this Boomlagoon.JSON.tfxJSONObject json_data)
		{
			return new Vector2(){ x = (float) json_data["x"].Number, y = (float) json_data["y"].Number };
		}

		public static Boomlagoon.JSON.tfxJSONValue ExportData (this Vector3 vec)
		{
			Boomlagoon.JSON.tfxJSONObject json_data = new Boomlagoon.JSON.tfxJSONObject();
			json_data["x"] = vec.x;
			json_data["y"] = vec.y;
		...
		public static Vector3 JSONtoVector3 (this Boomlagoon.JSON.tfxJSONObject json_data)
		{
			return new Vector3() {
		...
		public static Boomlagoon.JSON.tfxJSONValue ExportData (this Color color)
		{
			Boomlagoon.JSON.tfxJSONObject json_data = new Boomlagoon.JSON.tfxJSONObject();
		...
		public static Color JSONtoColor (this Boomlagoon.JSON.tfxJSONObject json_data)
		{
			return new Color()
			{
		...
		public static Boomlagoon.JSON.tfxJSONValue ExportData (this VertexColour vert_color)
		{
			Boomlagoon.JSON.tfxJSONObject json_data = new Boomlagoon.JSON.tfxJSONObject();
		...
		public static VertexColour JSONtoVertexColour (this Boomlagoon.JSON.tfxJSONObject json_data)
		{
		...
		public static Boomlagoon.JSON.tfxJSONValue ExportData (this UnityEngine.Keyframe frame)
		{
			Boomlagoon.JSON.tfxJSONObject json_data = new Boomlagoon.JSON.tfxJSONObject();
		...
		public static UnityEngine.Keyframe JSONtoKeyframe (this Boomlagoon.JSON.tfxJSONObject json_data)
		{
		...
		public static Boomlagoon.JSON.tfxJSONValue ExportData (this AnimationCurve curve)
		{
			Boomlagoon.JSON.tfxJSONArray key_frame_data = new Boomlagoon.JSON.tfxJSONArray();
		...
		public static AnimationCurve JSONtoAnimationCurve (this Boomlagoon.JSON.tfxJSONArray json_data)
		{
			AnimationCurve anim_curve = new AnimationCurve();
			anim_curve.keys = new Keyframe[0];
			
			foreach(Boomlagoon.JSON.tfxJSONValue frame_data in json_data)
			{
